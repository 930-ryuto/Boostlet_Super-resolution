...
# Modified in 2026 for NumPy 2 tuple-arithmetic compatibility and corrected
# two-dimensional padding. See copyright.txt and LICENSE in this package.
...
def SLcheckFilterSizes(rows,cols, shearLevels,directionalFilter,scalingFilter,
    ...
    h0, h1 = h0 / np.sqrt(2), h1 / np.sqrt(2)
